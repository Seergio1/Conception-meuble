 ...
 * @author sergi
 */
@WebServlet(name = "AffichageMatiereStyle", urlPatterns = { "/affichageMatiereStyle" })
public class AffichageMatiereStyle extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println(allStyle.get(0).getId());
