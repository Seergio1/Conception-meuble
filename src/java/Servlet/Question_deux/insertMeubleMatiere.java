 ...
 * @author sergi
 */
@WebServlet(name = "insertMeubleMatiere", urlPatterns = {"/insertMeubleMatiere"})
public class insertMeubleMatiere extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            v_meuble_matiereDAO.insert(id_meuble, id_matiere, quantite, null);
