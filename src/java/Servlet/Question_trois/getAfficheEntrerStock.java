 ...
 * @author sergi
 */
@WebServlet(name = "getAfficheEntrerStock", urlPatterns = {"/getAfficheEntrerStock"})
public class getAfficheEntrerStock extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("/question_trois/affichageEntre.jsp").forward(request, response);
        } catch (Exception e) {
