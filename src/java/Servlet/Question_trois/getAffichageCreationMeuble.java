 ...
 * @author sergi
 */
@WebServlet(name = "getAffichageCreationMeuble", urlPatterns = {"/getAffichageCreationMeuble"})
public class getAffichageCreationMeuble extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("/question_trois/affichageCreationMeuble.jsp").forward(request, response);
        } catch (Exception e) {
